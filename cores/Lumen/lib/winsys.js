  ...
  data: {
    ...
    win: class Win {
      ...
      createWindow() {
        ...
        let wrapper = new Html().html(`<div class="win-window">
        <div class="win-titlebar">
        <div class="outer-title"><div class="title"></div></div>
            <div class="buttons">
                <button class="win-btn win-minimize" aria-label="Minimize">Minimize window</button>
                <button class="win-btn win-maximize" aria-label="Maximize">Maximize window</button>
                <button class="win-btn win-close" aria-label="Close">Close window</button>
            </div>
        </div>
          ...
          switch (side) {
            ...
            case "left":
              ...
              this.window.style.height =
                this.window.parentNode.offsetHeight + "px";
              this.window.style.top = 0;
              this.window.style.left = 0;
      ...
      if (newPositionY < snapMargin) {
        ...
        animateSnapIndicator(
          ...
          },
          {
            ...
            height: winRef.parentNode.offsetHeight - snapBoxMargin * 2 + "px",
